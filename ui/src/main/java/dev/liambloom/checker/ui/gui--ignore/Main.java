...
//    private final SimpleBooleanProperty isProjectOpen = new SimpleBooleanProperty(false);
    ...
    public Main() {
        setColorScheme(ColorScheme.valueOf(Preferences.userRoot().node("dev/liambloom/checker").get("colorScheme", ColorScheme.LIGHT.name())));
    }
    ...
    public void setColorScheme(ColorScheme colorScheme) {
        ...
        Preferences.userRoot().node("dev/liambloom/checker").put("colorScheme", colorScheme.name());
